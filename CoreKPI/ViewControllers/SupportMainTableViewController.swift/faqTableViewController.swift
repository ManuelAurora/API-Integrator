...
class faqTableViewController: UITableViewController {
    ...
    let headersOfQestion = ["Question: Dashboards","Question: Dashboards", "Question: Alerts"]
...
//        cell.describeOfQuestionLabel.text = descriptionsOfQuestion[indexPath.row]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "FaqDetai" {
            let destinationViewController = segue.destination as! faqDetailViewController
            destinationViewController.headersOfQestion = headersOfQestion
            destinationViewController.descriptionsOfQuestion = descriptionsOfQuestion
