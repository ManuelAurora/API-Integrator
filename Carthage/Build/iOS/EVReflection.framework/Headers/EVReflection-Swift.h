...
@interface NSDictionary (SWIFT_EXTENSION(EVReflection))
/**
  Create a json string based on this dictionary
  \param prettyPrinted compact of pretty printed

*/
- (NSString * _Nonnull)toJsonStringWithPrettyPrinted:(BOOL)prettyPrinted;
/**
  Create a json data based on this dictionary
  \param prettyPrinted compact of pretty printed

*/
- (NSData * _Nonnull)toJsonDataWithPrettyPrinted:(BOOL)prettyPrinted;
@end


@interface NSMutableDictionary (SWIFT_EXTENSION(EVReflection))
/**
  Initialize a Dictionary based on a json string
*/
- (nonnull instancetype)initWithJson:(NSString * _Nonnull)json;
/**
