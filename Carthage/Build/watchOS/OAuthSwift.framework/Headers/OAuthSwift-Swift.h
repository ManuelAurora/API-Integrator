...
+ (NSString * _Nonnull)separator SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSData * _Nonnull separatorData;)
+ (NSData * _Nonnull)separatorData SWIFT_WARN_UNUSED_RESULT;
...
@interface OAuthSwiftHTTPRequest (SWIFT_EXTENSION(OAuthSwift))
+ (NSString * _Nonnull)descriptionForHTTPStatus:(NSInteger)status responseString:(NSString * _Nonnull)responseString SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (NSString * _Nonnull)userActivityType SWIFT_WARN_UNUSED_RESULT;
